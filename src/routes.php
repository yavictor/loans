...
$app->get(
    '/loans/all', function (Request $request, Response $response): Response {
...
$app->get(
    '/loans/{id}', function (Request $request, Response $response): Response {
...
$app->post(
    ...
    function (Request $request, Response $response, array $args
        ...
        $sql = "INSERT INTO loans (value, term, interest_rate)
                VALUES (:value, :term, :interest_rate);";
